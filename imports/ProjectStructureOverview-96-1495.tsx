import svgPaths from "./svg-hr3vy50la";
...
function Container3() {
  return (
    <div className="h-[51.195px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Inter:Black',sans-serif] font-black leading-[51.2px] left-0 not-italic text-[32px] text-nowrap text-white top-[0.5px] tracking-[0.4063px] whitespace-pre">5</p>
    </div>
  );
}
...
function Container5() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0.05)] box-border content-stretch flex flex-col gap-[4px] h-[105.195px] items-start left-0 pb-px pt-[17px] px-[17px] top-0 w-[130.594px]" data-name="Container">
...
function Container8() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0.05)] box-border content-stretch flex flex-col gap-[4px] h-[105.195px] items-start left-[146.59px] pb-px pt-[17px] px-[17px] top-0 w-[130.602px]" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[rgba(255,255,255,0.1)] border-solid inset-0 pointer-events-none" />
      <Container6 />
      <Container7 />
    </div>
...
function Container11() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0.05)] box-border content-stretch flex flex-col gap-[4px] h-[105.195px] items-start left-[293.2px] pb-px pt-[17px] px-[17px] top-0 w-[130.602px]" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[rgba(255,255,255,0.1)] border-solid inset-0 pointer-events-none" />
      <Container9 />
      <Container10 />
    </div>
...
function Container12() {
  return (
    <div className="h-[51.195px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Inter:Black',sans-serif] font-black leading-[51.2px] left-0 not-italic text-[32px] text-nowrap text-white top-[0.5px] tracking-[0.4063px] whitespace-pre">NaN</p>
    </div>
  );
}
...
function Container14() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0.05)] box-border content-stretch flex flex-col gap-[4px] h-[105.195px] items-start left-[439.8px] pb-px pt-[17px] px-[17px] top-0 w-[130.602px]" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[rgba(255,255,255,0.1)] border-solid inset-0 pointer-events-none" />
      <Container12 />
      <Container13 />
    </div>
...
function Container15() {
  return (
    <div className="h-[51.195px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Inter:Black',sans-serif] font-black leading-[51.2px] left-0 not-italic text-[32px] text-white top-[0.5px] tracking-[0.4063px] w-[89px]">NaNK</p>
    </div>
  );
}
...
function Container17() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0.05)] box-border content-stretch flex flex-col gap-[4px] h-[105.195px] items-start left-[586.4px] pb-px pt-[17px] px-[17px] top-0 w-[130.602px]" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[rgba(255,255,255,0.1)] border-solid inset-0 pointer-events-none" />
      <Container15 />
      <Container16 />
    </div>
...
function Icon2() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icon">
          <path d={svgPaths.p1d59db00} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.4" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="basis-0 grow h-[17.594px] min-h-px min-w-px relative shrink-0" data-name="BeaconsGlobe">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[17.594px] relative w-full">
        <p className="absolute font-['Inter:Black',sans-serif] font-black leading-[17.6px] left-[28px] not-italic text-[11px] text-[rgba(255,255,255,0.4)] text-center text-nowrap top-0 tracking-[0.0645px] translate-x-[-50%] whitespace-pre">BEACONS</p>
      </div>
    </div>
  );
}
...
function Canvas() {
  return (
    <div className="absolute h-[388px] left-0 top-0 w-[781px]" data-name="Canvas">
...
function Container26() {
  return (
    <div className="absolute bg-[rgba(0,0,0,0.8)] box-border content-stretch flex flex-col gap-[8px] h-[118.781px] items-start left-[24px] pb-px pt-[17px] px-[17px] top-[245.22px] w-[184.531px]" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[rgba(255,255,255,0.2)] border-solid inset-0 pointer-events-none" />
      <Container21 />
      <Container25 />
    </div>
...
function Text() {
  return (
    <div className="h-[17.594px] relative shrink-0 w-[44.867px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[17.594px] relative w-[44.867px]">
...
function Container33() {
  return (
    <div className="absolute bg-[rgba(0,0,0,0.8)] box-border content-stretch flex flex-col gap-[12px] h-[105.188px] items-start left-[618.3px] pb-px pt-[17px] px-[17px] top-[258.81px] w-[138.703px]" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[rgba(255,255,255,0.2)] border-solid inset-0 pointer-events-none" />
      <Container27 />
      <Container32 />
    </div>
...
function App() {
  return (
    <div className="absolute bg-black box-border content-stretch flex flex-col h-[1232.28px] items-start left-0 pl-[320px] pr-0 py-0 top-0 w-[1101px]" data-name="App">
      <BeaconsGlobe2 />
      <Footer />
    </div>
  );
...
function Container48() {
  return (
    <div className="opacity-[0.587] relative rounded-[1.67772e+07px] shrink-0 size-[8px]" data-name="Container">
