...
import { RightNowPagePro } from '../pages/RightNowPagePro';
import { RightNowCreatePage } from '../pages/RightNowCreatePage';
import { RightNowLivePage } from '../pages/RightNowLivePage';
import { RightNowRealtimeTest } from '../pages/RightNowRealtimeTest';
...
import { AdminWarRoom } from '../pages/admin/AdminWarRoom';
...
// Beacon OS Demo pages
import { BeaconsDemoHome } from '../pages/BeaconsDemoHome';
import { BeaconScanDemo } from '../pages/BeaconScanDemo';
...
export function Router({ currentRoute, routeParams, onNavigate }: RouterProps) {
  ...
  const routes: Partial<Record<RouteId, JSX.Element>> = {
    ...
    // RIGHT NOW
    rightNow: <RightNowShell />,
    rightNowCreate: <RightNowCreateForm />,
    rightNowPagePro: <RightNowPagePro onNavigate={navigate} />,
    rightNowCreatePage: <RightNowCreatePage onNavigate={navigate} />,
    rightNowLivePage: <RightNowLivePage onNavigate={navigate} />,
    rightNowRealtimeTest: <RightNowRealtimeTest onNavigate={navigate} />,
    ...
    adminIntegrations: <AdminIntegrations onNavigate={navigate} />,
    ...
    adminWarRoom: <AdminWarRoom onNavigate={navigate} />,
    ...
    // Beacon OS Demo
    beaconsDemoHome: <BeaconsDemoHome onNavigate={navigate} />,
    beaconScanDemo: <BeaconScanDemo code={routeParams?.code} onNavigate={navigate} routeParams={routeParams} />,
