...
import { Play, Calendar, Radio, Heart, TrendingUp, ChevronRight, Scan, ArrowRight, Zap } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-black">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              >
                <span className="relative flex">
                  ...
                  <span className="absolute w-3 h-3 rounded-full bg-white opacity-75 animate-ping" />
                </span>
                RIGHT NOW
              ...
              <button
                ...
                className="group inline-flex items-center gap-3 h-16 px-10 border border-white/30 text-white hover:bg-white hover:text-black transition-all text-lg uppercase tracking-wider font-semibold"
              >
                Enter City Rooms
                <ArrowRight className="group-hover:translate-x-1 transition-transform" size={20} />
              </button>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 pb-32">
        <section className="border border-hotmess-red/30 bg-gradient-to-br from-hotmess-red/5 to-transparent p-12 md:p-16 hover-lift">
          <div className="flex items-center gap-3 mb-6">
            <Zap className="text-hotmess-red" size={32} strokeWidth={1.5} />
            <h2 className="uppercase">RIGHT NOW Testing</h2>
          </div>
          <p className="text-xl text-white/60 mb-4 text-editorial max-w-3xl">
            Actually working connection tests for the RIGHT NOW system
          </p>
          <p className="text-sm text-white/40 mb-8 max-w-2xl">
            Real database queries · Live Edge Function · No BS
          </p>
          <div className="flex flex-wrap gap-4">
            <button
              onClick={() => onNavigate('rightNowRealtimeTest')}
              className="group inline-flex items-center gap-3 h-14 px-8 bg-gradient-to-r from-hotmess-red to-[#ff0080] text-white hover:from-white hover:to-hotmess-red hover:text-black transition-all uppercase tracking-wider font-semibold shadow-[0_0_30px_rgba(255,22,148,0.4)] hover:shadow-[0_0_50px_rgba(255,22,148,0.7)]"
            >
              <Zap size={18} />
              Test System
            ...
            <button
              onClick={() => onNavigate('rightNow')}
              className="group inline-flex items-center gap-3 h-14 px-8 border border-brutal hover:bg-white/5 transition-all uppercase tracking-wider font-semibold text-white"
            >
              Live Feed
              <ArrowRight className="group-hover:translate-x-1 transition-transform" size={18} />
            </button>
