...
import privacyApiApp from "./privacy_api.tsx"; // NEW: GDPR Privacy Hub API
import rightNowApiApp from "./rightnow_api.tsx"; // NEW: RIGHT NOW temporal posts API
...
// Mount GDPR Privacy Hub API routes
app.route("/make-server-a670c824/api/privacy", privacyApiApp);

// Mount RIGHT NOW temporal posts API routes (at /right-now to match frontend)
app.route("/make-server-a670c824/right-now", rightNowApiApp);
