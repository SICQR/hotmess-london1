...
export type RouteId =
  ...
  // RIGHT NOW - Live hookup/crowd feed system
  | "rightNow"
  | "rightNowCreate"
  | "rightNowRealtimeTest"  // NEW: Test realtime subscriptions
  | "tickets"
  | "ticketsBeacon"
  | "ticketsListing"
  | "ticketsPurchase"
  ...
  | "beaconsEarth3d"
  // Beacon OS Demo
  | "beaconsDemoHome" // NEW: Beacon OS demo directory
  | "beaconScanDemo"  // NEW: Beacon OS demo scan page
  // Account
  | "account"
  | "accountProfile"
  | "accountOrders"
...
export const ROUTES: Record<RouteId, RouteDef> = {
  ...
  rightNowCreate: {
    ...
    href: "/right-now/create",
    group: "hidden",
    auth: true,
    description: "Create a new Right Now beacon",
  },
  rightNowRealtimeTest: {
    id: "rightNowRealtimeTest",
    label: "Realtime Test",
    href: "/right-now/realtime-test",
    group: "hidden",
    auth: true,
  ...
  beaconsDemoHome: {
    id: "beaconsDemoHome",
    label: "Beacon OS Demo",
    href: "/beacons/demo",
    group: "hidden",
    description: "Beacon OS demo directory",
  },
  beaconScanDemo: {
    id: "beaconScanDemo",
    label: "Beacon OS Demo Scan",
    href: "/beacons/demo/scan",
    group: "hidden",
    description: "Beacon OS demo scan page",
  },
