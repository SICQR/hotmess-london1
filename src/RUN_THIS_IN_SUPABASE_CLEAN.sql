-- ============================================================================
-- HOTMESS LONDON - CLUB MODE SCHEMA (CLEAN VERSION)
...
-- Public read policy (for now - tighten later)
...
-- SELECT id, name, slug, status FROM clubs WHERE slug = 'default';

-- ============================================================================
-- DONE! Club Mode is now ready to use.
-- Navigate to /club/default in your app to test.
-- ============================================================================
